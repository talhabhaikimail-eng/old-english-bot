...
export type NavSection = 'sessions' | 'manager' | 'courses' | 'android' | 'ai-tools' | 'media' | 'youtube' | 'movies' | 'urls' | 'llm' | 'search' | 'tts' | 'places' | 'google' | 'web-proxy' | 'pool' | 'go-containers' | 'indeed' | 'contacts' | 'blog-gen' | 'code-exec' | 'proxy-net' | 'shell';
